 ...
 * Description:       This plugin is use for take a quick order from anywhere of your website, using [woo-quick-order] shortcode.
 * Version:           1.0.0
 ...
 */
define( 'WOOCOMMERCE_QUICK_ORDER_VERSION', '1.0.0' );
define( 'WOOCOMMERCE_QUICK_ORDER__FILE__', __FILE__ );
define( 'WOOCOMMERCE_QUICK_ORDER_PLUGIN_BASE', plugin_basename( WOOCOMMERCE_QUICK_ORDER__FILE__ ) );
define( 'WOOCOMMERCE_QUICK_ORDER_PATH', plugin_dir_path( WOOCOMMERCE_QUICK_ORDER__FILE__ ) );
define( 'WOOCOMMERCE_QUICK_ORDER_TEXT_DOMAIN', 'woocommerce-quick-order' );
define( 'WOOCOMMERCE_QUICK_ORDER_REQ_PHP_VERSION', '7.2.0' );
define( 'WOOCOMMERCE_QUICK_ORDER_REQ_WC_VERSION', '6.9.0' );
...
function run_woocommerce_quick_order() {
	...
	$plugin = new Woocommerce_Quick_Order();
	$plugin->run();

}
run_woocommerce_quick_order();
